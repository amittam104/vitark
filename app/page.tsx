...
export default function Home() {
  ...
  return (
    <div className="w-full  flex flex-col items-center pt-20 gap-12 max-w-[88rem] mx-auto">
      <h1 className="text-5xl font-light max-w-2xl text-center leading-snug text-slate-900 dark:text-slate-50 tracking-tight">
      ...
      <div className="grid grid-cols-16 grid-rows-12 w-full gap-5">
        ...
        <div className="bg-gradient-to-br from-slate-50/20 to-slate-100/60 dark:from-slate-900/90 dark:to-slate-800/60 border relative border-slate-200 overflow-hidden rounded-lg px-6 py-6 dark:bg-slate-950 dark:border-slate-800 col-start-5 col-end-10 row-start-1 row-end-6">
          ...
          <Button
            variant="outline"
            className="absolute top-32 -right-4 text-slate-800 dark:text-slate-300/80 opacity-50 bg-slate-100 dark:bg-slate-400/60">
          ...
          <Button
            variant="outline"
            className="absolute top-44 -right-4 text-slate-800 dark:text-slate-300/80 opacity-50 bg-slate-100 dark:bg-slate-400/60">
            ...
            {weeklyTracker.map((day) => {
              return (
                <div key={day.id} className="flex flex-col items-center gap-1">
                  <div
                    className={`flex items-center border-2 justify-center p-3 rounded-lg ${
                      day.status === "yes"
        ...
        <div className="bg-slate-900 dark:bg-slate-400/20 border border-slate-800 text-slate-50 rounded-lg px-6 py-6  dark:border-slate-700 col-start-10 col-span-7  row-start-1 row-end-6">
